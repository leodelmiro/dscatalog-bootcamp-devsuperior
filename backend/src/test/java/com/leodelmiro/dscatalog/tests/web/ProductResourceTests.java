package com.leodelmiro.dscatalog.tests.web;
...
public class ProductResourceTests {
    ...
    @Test
    public void insertShouldReturnCreatedWhenProductDataValid() throws Exception {
    ...
    @Test
    public void insertShouldReturnUnprocessableEntityWhenProductPriceIsNotPositive() throws Exception {

        String accessToken = obtainAccessToken(operatorUsername, operatorPassword);

        newProductDTO.setPrice(-10000.0);
        String jsonBody = objectMapper.writeValueAsString(newProductDTO);
